...
export default function TeamApp({ isOpen, onOpen }: TeamAppProps) {
    ...
    return (
        <button
            ...
            onClick={onOpen}
            className="group fixed left-[2.25rem] top-[13.4rem] z-[24] grid w-[clamp(7.8rem,16vw,11.2rem)] cursor-pointer content-start justify-items-center gap-[0.8rem] border border-transparent bg-transparent px-[0.42rem] py-[0.63rem] transition-colors duration-100 hover:border-[#cfd5df]/55 hover:bg-[#b7bcc8]/28 focus-visible:border-[#d5dbe5]/65 focus-visible:bg-[#b7bcc8]/32 max-[760px]:top-[11.8rem]"
        >
            <span
            ...
            >
                <Image
                    src="/assets/icons/Documents-5.png"
                    alt=""
                    fill
