...
export default function TeamApp({ isOpen, onOpen }: TeamAppProps) {
    ...
    return (
        <button
            ...
            onClick={onOpen}
            className="group fixed left-[2.25rem] top-[13.4rem] grid w-[clamp(8.85rem,18.3vw,12.75rem)] cursor-pointer content-start justify-items-center gap-[0.87rem] border-0 bg-transparent px-[0.48rem] py-[0.63rem] max-[760px]:top-[11.8rem]"
        >
            <span
